const Game = {
	create: function() {
		...
		this.ballStartPos = { x: 320*0.5, y: 450 };

		this.pauseButton = this.add.button(320-8, 8, 'button-pause', this.managePause, this);
		this.pauseButton.anchor.set(1,0);
		this.pauseButton.input.useHandCursor = true;
		this.audioButton = this.add.button(320-this.pauseButton.width-8*2, 8, 'button-audio', this.manageAudio, this);
		...
		this.hole = this.add.sprite(320*0.5, 90, 'hole');
		...
		this.borderGroup.create(0, 480-2, 'border-horizontal');
		this.borderGroup.create(0, 0, 'border-vertical');
		this.borderGroup.create(320-2, 0, 'border-vertical');
	...
	managePause: function() {
		...
		var pausedText = this.add.text(320*0.5, 250, "Game paused,\ntap anywhere to continue.", this.fontMessage);
